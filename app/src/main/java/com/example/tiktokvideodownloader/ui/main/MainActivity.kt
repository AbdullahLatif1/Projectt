...
import com.example.tiktokvideodownloader.ui.main.queue.DownloadFragment
import com.example.tiktokvideodownloader.ui.main.queue.QueueFragment
    ...
    private fun setupBottomNavigationView(bottomNavigationView: BottomNavigationView, savedInstanceState: Bundle?) {
        bottomNavigationView.setOnItemSelectedListener { item ->
            val fragment = when (item.itemId) {
                ...
                R.id.queue_menu_download -> DownloadFragment.newInstance()
